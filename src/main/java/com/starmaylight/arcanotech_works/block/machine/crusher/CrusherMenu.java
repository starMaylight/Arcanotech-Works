...
public class CrusherMenu extends AbstractContainerMenu {
    ...
    public CrusherMenu(int containerId, Inventory playerInventory, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.CRUSHER.get(), containerId);
        
        checkContainerSize(playerInventory, CrusherBlockEntity.SLOT_COUNT);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            // 入力スロット
            this.addSlot(new SlotItemHandler(handler, CrusherBlockEntity.INPUT_SLOT, INPUT_SLOT_X, INPUT_SLOT_Y));
            // 出力スロット
            this.addSlot(new SlotItemHandler(handler, CrusherBlockEntity.OUTPUT_SLOT, OUTPUT_SLOT_X, OUTPUT_SLOT_Y) {
                @Override
                public boolean mayPlace(ItemStack stack) {
                    return false;  // 出力スロットには直接置けない
                }
            });
            // 冷却スロット
            this.addSlot(new SlotItemHandler(handler, CrusherBlockEntity.COOLING_SLOT, COOLING_SLOT_X, COOLING_SLOT_Y));
        });
