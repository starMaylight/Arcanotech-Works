...
public class RollingMillMenu extends AbstractContainerMenu {
    ...
    public RollingMillMenu(int containerId, Inventory playerInventory, FriendlyByteBuf buf) {
    ...
    public RollingMillMenu(int containerId, Inventory playerInventory, BlockEntity entity, ContainerData data) {
        ...
        checkContainerSize(playerInventory, RollingMillBlockEntity.SLOT_COUNT);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            // 入力スロット
            this.addSlot(new SlotItemHandler(handler, RollingMillBlockEntity.INPUT_SLOT, INPUT_SLOT_X, INPUT_SLOT_Y));
            // 出力スロット
            this.addSlot(new SlotItemHandler(handler, RollingMillBlockEntity.OUTPUT_SLOT, OUTPUT_SLOT_X, OUTPUT_SLOT_Y) {
                @Override
            ...
            // 冷却スロット
            this.addSlot(new SlotItemHandler(handler, RollingMillBlockEntity.COOLING_SLOT, COOLING_SLOT_X, COOLING_SLOT_Y));
        });
